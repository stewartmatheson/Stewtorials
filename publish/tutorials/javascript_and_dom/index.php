...
<h3 class=add_to_toc>Document Object Model</h3>
<p>Javascript's most common use is interacting with the document object model. The "DOM" is a tree structure that is built from HTML elements on a given web page. Each element is one branch on the tree. Branches on this tree can have other branches. Much as the same way files and folders work. These relationships are called child-parent relationships. A given element can have one parent and can also have many children. The HTML element is the only element in a given page that does not have a parent. It is the top most element and as such is referred to as the root of the tree.</p>

<p>Understanding the DOM is an important part of learning JavaScript and how to add interactivity to web pages. Without a firm understanding of the DOM you will be unable to write dynamic web pages.</p>

<h3 class=add_to_toc>DOM: Elements</h3>
<p>As discussed the DOM is made up of elements. Javascript performs actions on these DOM elements. This allows us to change the page in any way we need even after a page has been loaded. Coupled with this is an events system we can use to create fully functional and interactive experiences.</p>

<h3 class=add_to_toc>Exercise: Explore the DOM</h3>
<div class=exercise>
    <ol>
...
<h3 class=add_to_toc>jQuery</h3>
<p>Javascript can be used to control the DOM. However the design of JavaScript around interacting with the DOM is poor. Developers end up spending a lot of time rewriting the same code. There are also cross browser issues to consider. What works in one browser might not work in another. There are many frameworks that are available out there that that help JavaScript developers. One such framework is <a href="http://jquery.com">jQuery</a>.</p>

<p>jQuery makes writing JavaScript a much more enjoyable experience.  jQuery aims to simplify some of the more common tasks in JavaScript development. jQuery also unifies the experience over different browsers. This is handy as it allows developers to be more productive. jQuery is used widely in industry and is open and free.</p>

<p>To use jQuery we must include the jQuery library file in our source code of our page. Google host jQuery and a number of other handy JavaScript libraries for us. This is handy as we don't have to download the library and set it up each time. We can just include a link to Google's hosted version. The following example is how to do this.</p>

<?php render_code_block('html', "include_jquery.html", "Including jQuery in a page."); ?>

<h3 class=add_to_toc>jQuery Selectors</h3>
...
<h3 class=add_to_toc>Exercise: Selectors</h3>
<div class=exercise>
    <ol>
...
<h3 class=add_to_toc>Document Ready</h3>
<p>One of the most common tasks performed in jQuery is initialisation. This is an event that fires when the document is loaded in the browser. Any code that sets up other events such as mouse clicks and keyboard events should be run when the document is ready. Fortunately jQuery provides us with a way of binding events to document ready. Through out these tutorials you will need to always set up your jQuery code to run on document ready otherwise it will not work</p>

<?php render_code_block('js', "document_ready.js", "Binding events with document ready."); ?>

<h3 class=add_to_toc>Exercise: Document Ready</h3>
<div class=exercise>
	<ol>
		<li>Create a new HTML file</li>
		<li>Include jQuery from the Google API in your file</li>
...
<p>Performing actions on the DOM using jQuery is done via the jQuery object. The jQuery object is a JavaScript object with all of the functions contained within jQuery. This global can be referenced in two ways. Either by the word "jQuery" or by the "$" sign. The "$" sign is more common and makes for less code however its up to the writer as to what they want to use as both work.</p>


<?php render_code_block('js', "jquery_object.js", "Using the JavaScript object"); ?>

<h3 class=add_to_toc>Exercise: jQuery Object</h3>
<div class=exercise>
	<ol>
		<li>Create a new HTML file</li>
		<li>Include jQuery from the Google API in your file</li>
...
<p>When using jQuery there are two main steps. First is working out the correct selector for your needs and the second is performing operations on that selector. Operations in jQuery are functions that are callable from the jQuery object. When we use the jQuery object and type a selector then any more operations we perform on that object will be applied to all of the elements selected. As we are dealing with a single jQuery object we can also use method chaining to apply multiple operations.</p>

<?php render_code_block('js', "jquery_operations.js", "jQuery operations and method chaining"); ?>

<h3 class=add_to_toc>Exercise: Manipulation</h3>
<div class=exercise>
	<ol>
		<li>Create a new HTML file</li>
		<li>Include jQuery from the Google API in your file</li>
...
<h3 class=add_to_toc>Exercise: Effects</h3>
<div class=exercise>
	<ol>
		<li>Create a new HTML file</li>
		<li>Include jQuery from the Google API in your file</li>
